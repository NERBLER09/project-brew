...
<div class="relative flex flex-nowrap items-start gap-lg overflow-x-auto pb-4 md:gap-2xl">
	<div class="relative flex items-center">
		<div class="relative mr-md w-[170px]">
			<span class="font-bold text-grey-700 dark:text-grey-300">Name</span>
			<div class="absolute right-0 top-0 h-full w-1 rounded-t-full bg-grey-700 dark:bg-grey-300" />
		</div>
		<div class="relative mr-md w-[170px]">
